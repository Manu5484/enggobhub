...
export default function HomePageForm() {
  ...
  return (
    <div className="StandOutContainerdiv">
      <h1>Stand Out among Recruiters</h1>
    ...
    <div className="Standoutcontainer">
        ...
        <form className="homeform">
          <div className="input-block">
            <input
              ...
              required
            />
            <label htmlFor="email" className={label1 ${email ? "active" : ""}}>Username</label>
          </div>
          <div className="input-block">
            <input
              className="homeinput"
              ...
              required
            />
            <label htmlFor="pass" className={label1 ${password ? "active" : ""}}>Password</label>
          </div>
          <div className="input-block">
      ...
      <div className="right">
        <div className="homeimg">
          { }
          <img src="your-image-url.svg" alt="Illustration" width="100%" height="100%" />
        </div>
      </div>
    </div>
  );
